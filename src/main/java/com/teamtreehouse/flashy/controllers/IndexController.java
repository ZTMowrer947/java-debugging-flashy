...
public class IndexController {
  public static final int AMT_TO_SHOW = 3;
  ...
  public String index(Model model) {
    ...
    List<FlashCard> cards = flashCardService.getRandomFlashCards(AMT_TO_SHOW);
    ...
    if (totalCount > AMT_TO_SHOW) {
      ctaBuilder.append(" and ");
      ctaBuilder.append(totalCount - AMT_TO_SHOW);
